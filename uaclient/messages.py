...
SS_SUMMARY_THIRD_PARTY_SN = "{offset}{count} package is from a third party"
SS_SUMMARY_THIRD_PARTY_PL = "{offset}{count} packages are from third parties"
...
Ubuntu Pro with '{service}' enabled until {year}. You received {updates} security
